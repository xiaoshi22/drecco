...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', type=str, default='xw2138_drecco', help="name of the database")
    parser.add_argument('-u', type=str, default='xw2138', help="id of the database admin")
    parser.add_argument('-p', type=str, default='wp782sdp', help="passwd of the database admin")
